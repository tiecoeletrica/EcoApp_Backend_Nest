...
import { FetchAllMovimentationHistoryUseCase } from "./fetch-all-movimentations-history";
...
let sut: FetchAllMovimentationHistoryUseCase;
...
describe("Fetch Movimentations History", () => {
  beforeEach(() => {
    ...
    sut = new FetchAllMovimentationHistoryUseCase(
